...
Build mode includes the sample garden's structural and landscaping vocabulary: individual terrain blocks plus raised beds, seating, supports, bridges, hives, gazebos, trees, hedges, ponds, sheds, glasshouses, and pergolas. Paths, water, flower patches, and fences use purpose-built low-profile visuals instead of generic full-height cubes. Large objects reserve their complete footprint so layouts remain legible and objects do not overlap.
